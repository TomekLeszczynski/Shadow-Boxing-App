const preloaderQuotes = [
  ...
  {
    quote:
      '"Every time I step into the ring, I’m looking for a knockout. I’m there to make a statement."',
    author: 'Mike Tyson'
  },
  {
    quote:
  ...
  {
    quote: '"Train with the energy of a warrior and soon you will have the heart of a warrior."',
