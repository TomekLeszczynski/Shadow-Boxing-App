<template>
  <div
    class="bg-boxingGrey p-5 md:p-8 w-full sm:w-auto h-full sm:h-auto flex flex-col justify-center animate-flyInLeft"
  >
        ...
        >
          ...
          <div class="md:col-span-5 mb-6">
            ...
            <input
              ...
              v-model="email"
              type="email"
              class="h-10 my-1 px-4 w-full bg-almost-white border-none placeholder:text-almost-black"
          ...
          <button
            aria-label="log in"
            @click="signingIn"
            class="bg-almost-white text-almost-black text-lg font-semibold mt-5 py-5 px-12 flex flex-row items-center justify-center group tracking-wide w-full font-public-sans"
          >
