<template>
  <button
    ...
    class="bg-almost-white text-almost-black text-md md:text-lg font-semibold mt-5 py-4 md:py-5 md:px-6 flex items-center justify-center group tracking-wide w-full animate-button-show-from-left"
  >
